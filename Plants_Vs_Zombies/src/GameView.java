...
public class GameView implements PvZListener{
	...
	public GameView(){
		...
		sunPlant.addActionListener(new PvZController(model, -1, -1));
		peaPlant.addActionListener(new PvZController(model, -1, -1));
		...
		nextTurnButton.addActionListener(new PvZController(model, -1, -1));
